<template>
  <div class="step">
    ...
    <div class="step-actions">
      <button class="apple-btn apple-btn-secondary" @click="store.currentStep = 1">返回修改</button>
      <button class="apple-btn apple-btn-primary" @click="store.doGenerate()" style="padding:12px 24px;font-size:15px;">
        确认并生成文档
...
.risk-card { padding: 20px; border-radius: var(--radius); border: 0.5px solid var(--border); transition: all var(--transition); }
